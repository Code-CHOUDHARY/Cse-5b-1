...
//  Monday
        ...
        // Tuesday
        {
          ...
          4: [teacherLink.YP, "SE", "Yoothika Patel"],
          5: [teacherLink.YP, "SE", "Yoothika Patel"],
        },
        // Wednesday
        {
          0: [teacherLink.PD, "PSPE", "PALAK MAM"],
          1: [teacherLink.PR, "DAA", "Pushpak Raval"],
          2: [teacherLink.ASS, "ASS", "Aarti Sardhara"],
          3: [teacherLink.ASS, "ASS", "Aarti Sardhara"],
        ...
        // Friday
        {
          0: [teacherLink.VGB, "IOE(LAB)","Vimal Bhatt"],
          1: [teacherLink.VGB, "IOE(LAB)","Vimal Bhatt"],
          2: [teacherLink.LIB, "LIB", ""],
          3: [teacherLink.SE, "SE", "Yoothika Patel"],
          4: [teacherLink.ASS, "ASS", "Aarti Sardhara"],
          5: [teacherLink.ASS, "ASS", "Aarti Sardhara"],
        },
        // Satuarday
        {
